    ...
    <>
      ...
      <Container>
        ...
        <Grid container spacing={3} my={'60px'}>
          ...
          <Grid item xs={12} sm={12} md={6} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <Stack direction={'row'}>
              <Box>
                <img src='/images/phone-front.png' alt='Product' className='phoneImg' width='100%' maxWidth='281px' height='auto'></img>
              </Box>
              <Box sx={{ mt: '-30px', ml: '-40px' }}>
                <img src='/images/phone-side.png' alt='Product' className='phoneImg2' width='100%' maxWidth='234px' height='auto'></img>
              </Box>
            </Stack>
          </Grid>
        </Grid>
      ...
      <BoxStyle
        ...
        <Container>
          <Grid container spacing={3}>
            <Grid item xs={12} sm={12} md={6} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              <Box>
                <img src='/images/fastag-car.png' alt='Product' width={'100%'} height={'auto'} />
              </Box>
            </Grid>
            <Grid item xs={12} sm={12} md={6} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              <Box maxWidth={'550px'} width={'100%'} height={'auto'}>
      ...
      <Container>
        <Grid container spacing={3} sx={{ flexWrap: 'wrap-reverse', my: '60px' }}>
          ...
          <Grid item xs={12} sm={12} md={6} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <Box>
              <img src='/images/towing.png' alt='Product' width={'100%'} height={'auto'} />
            </Box>
          </Grid>
        </Grid>
