  ...
  return (
    <>
      <Container>
        ...
        <Grid container spacing={3} mt={'110px'}>
        ...
        <Grid container spacing={3} mt={'98px'}>
          ...
          <Grid item xs={12} sm={12} md={6} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <Stack direction={'row'}>
              <Box>
                <img src='/images/phone-front.png' alt='Logo' className='phoneImg' width='100%' maxWidth='281px' height='auto'></img>
              </Box>
              <Box sx={{ mt: '-30px', ml: '-40px' }}>
                <img src='/images/phone-side.png' alt='Logo' className='phoneImg2' width='100%' maxWidth='234px' height='auto'></img>
              </Box>
            </Stack>
          </Grid>
        </Grid>
